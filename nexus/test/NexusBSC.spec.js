...
describe("NexusBSC", function(done) {
  this.timeout(200000);
  ...
  before(async function() {
    ...
    const dappOracleFactory = await ethers.getContractFactory("DappOracleUsdGas", addr1);
    const nexusTokenFactory = await ethers.getContractFactory("NexusBSC", addr1);
