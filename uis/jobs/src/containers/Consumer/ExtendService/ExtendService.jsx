...
import classes from './ExtendService.module.scss';
...
class ExtendService extends Component {
        ...
        const forms = this.forms.map(el => {
            return (
                <Form
                    ...
                    previewValues={this.separateObject(this.state.extendService)} // update
                    isMobile={isMobile}
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(withLocalize(ExtendService));
