...
import classes from './UnapproveImage.module.scss';
...
const page = 'unapprove image'; // update
const stateSelector = 'unapproveImage'; // update

const ethereum = window.ethereum;

class UnapproveImage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            account: null,
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(withLocalize(UnapproveImage));