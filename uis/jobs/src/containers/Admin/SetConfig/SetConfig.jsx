...
import classes from './SetConfig.module.scss';
...
const page = 'set config'; // update
const stateSelector = 'setConfig'; // update
...
class SetConfig extends Component {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(withLocalize(SetConfig));
